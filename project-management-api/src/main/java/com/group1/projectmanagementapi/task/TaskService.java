...
public class TaskService {
    ...
    public Task updateOne(Task task) {
        ...
        Project existingProject = existingTask.getProjects();
        ...
        if (existingTask.getProjects() == null) {
            existingTask.setProjects(existingProject);
        }
    ...
    public void deleteOne(Long id) {
        ...
        Project project = task.getProjects();
        if (project != null) {
